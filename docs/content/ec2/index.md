...
!!! tip "Up next: reproduce this as code"
    [Terraform Fundamentals](../terraform-fundamentals/index.md) covers the tool and its core
    concepts. [EC2 with Terraform](../ec2-terraform/index.md) then reproduces this same setup as
    infrastructure as code — same instance, same security group, created and destroyed in a single
    command.
